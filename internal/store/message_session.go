...
func (s *SQLiteStore) SetMessageSession(chatID int64, messageID int, sessionID string) error {
	_, err := s.db.Exec(
...
func (s *SQLiteStore) GetSessionByMessage(chatID int64, messageID int) (string, error) {
